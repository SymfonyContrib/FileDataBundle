...
namespace SymfonyContrib\Bundle\FileDataBundle\DependencyInjection;
 ...
 */
class FileDataExtension extends Extension implements PrependExtensionInterface
{
    /**
     * @var string
     */
    public $formTemplate = 'FileDataBundle:Form:file-data-base.html.twig';
    ...
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        $container->setParameter('file_data.model_class', $config['model_class']);
    }
